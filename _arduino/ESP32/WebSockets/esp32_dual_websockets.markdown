...
description: "Dual WebSocket"
permalink: /arduino/esp8266/websocket_dual
category: esp32
...
const char* ssid = "North Korea's Wi-Fi";  // 🔹 Replace with your Wi-Fi SSID
const char* password = "**********";       // 🔹 Replace with your Wi-Fi password
const char* serverAddress = "10.0.0.59";   // 🔹 Your PC's IP  
